...
namespace api.Controllers
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        public async Task<ActionResult> AddDepartment([FromBody] DepartmentUpdateAndCreateDto departmentDto, int id)
        {
            ...
            var checkExist = await _departmentRepo.GetDepartmentByIdAsync(id);
            if (checkExist != null)
            {
                return BadRequest("Phòng ban đã tồn tại, vui lòng kiểm tra lại");
            }

            var departmentUpdate = await _departmentRepo.AddAsync(departmentDto, id);
        ...
        [HttpPut("update/{id}")]
        public async Task<ActionResult> UpdateDepartment([FromBody] DepartmentUpdateAndCreateDto departmentDto, int id)
        {
