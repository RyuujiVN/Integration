...
namespace api.Repositories
{
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        public Task<DepartmentDto> AddAsync(DepartmentUpdateAndCreateDto departmentDto, int id)
        {
            var mySqlDepartment = departmentDto.toCreateMySqlDepartment(id);
            _mySqlDbContext.Departments.Add(mySqlDepartment);
            _mySqlDbContext.SaveChanges();
            var sqlServerDepartment = departmentDto.toCreateSqlServerDepartment(id);
        ...
        public Task<DepartmentDto?> UpdateDepartmentAsync(DepartmentUpdateAndCreateDto departmentDto, int id)
        {
