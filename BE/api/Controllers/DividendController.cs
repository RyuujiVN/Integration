...
namespace api.Controllers
{
    ...
    public class DividendController : ControllerBase
    {
        ...
        public DividendController(IDividendRepository dividendRepository, IEmployeeRepository employeeRepository)
        {
        ...
        public async Task<IActionResult> AddDividend([FromBody] CreateDividendDto dividendDto)
        {
            ...
            int idEmployee = dividendDto.EmployeeID??0;
            var existingEmployee = await _employeeRepository.GetEmployeeByIdAsync(idEmployee);
            ...
            {
                return BadRequest("Cổ tức đã tồn tại.");
            }
