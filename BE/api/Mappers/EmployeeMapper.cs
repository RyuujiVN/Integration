...
namespace api.Mappers
{
    public static class EmployeeMapper
    {
        ...
        public static api.Models.MySql.Employee toCreateMySqlEmployee(this CreateEmployeeDto dto)
        {
        ...
        public static api.Models.SqlServer.Employee toCreateSqlServerEmployee(this CreateEmployeeDto dto)
        {
        ...
        public static api.Models.MySql.Employee toUpdateMySqlEmployee(this UpdateEmployeeDto dto, int id)
        {
            return new api.Models.MySql.Employee
            {
                EmployeeID = id,
        ...
        public static api.Models.SqlServer.Employee toUpdateSqlServerEmployee(this UpdateEmployeeDto dto, int id)
        {
            return new api.Models.SqlServer.Employee
            {
                EmployeeID = id,
